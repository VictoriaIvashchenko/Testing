...
class CalendarTest {
    ...
    /**
     * Asserts that the method {@code calendar} correctly calculates the day of the week for a given day in a specific month.
     *
     * <p>This method tests the behavior of the {@code calendar} method by comparing its output to the expected weekday for a
     * specific day in a month. It ensures that the {@code calendar} method returns the correct weekday name based on the
    ...
    /**
     * Asserts that the method {@code calendar} correctly throws an {@code InvalidInputException} for illegal day values
     * in a given month.
     *
     * <p>This method tests various boundary cases and invalid day values to ensure that the {@code calendar} method correctly
    ...
    /**
     * Asserts that the method {@code calendar} throws an {@code InvalidInputException} with the correct message for
    ...
    /**
     * Asserts that the method {@code calendar} throws an {@code InvalidInputException} with the expected message for
